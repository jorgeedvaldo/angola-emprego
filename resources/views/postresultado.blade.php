...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-5 fw-bold text-dark mb-4">Veja Os Resultados da Prova do Concurso do CSMJ (Conselho
                        Superior da Magistratura Judicial)</h1>
                    ...
                    <div class="bg-white p-lg-5 p-4 rounded-3 text-dark shadow-sm border mb-4 article-content">
                        ...
                        <div class="d-flex gap-2 mb-4">
                            <a class="btn btn-outline-primary btn-sm rounded-pill px-3"
                                href="https://www.facebook.com/sharer/sharer.php?u={{ url('/noticias/resultados-concurso-csmj-2026') }}"
                                target="_blank"><i class="bi bi-facebook me-1"></i> Partilhar</a>
                            <a class="btn btn-outline-success btn-sm rounded-pill px-3"
                                href="https://api.whatsapp.com/send?text=Resultados do Concurso CSMJ 2026 - Pesquise pelo seu nome: {{ url('/noticias/resultados-concurso-csmj-2026') }}"
                                target="_blank"><i class="bi bi-whatsapp me-1"></i> WhatsApp</a>
                        </div>

                        <div class="mb-4">
                            <p class="lead">O <strong>Conselho Superior da Magistratura Judicial (CSMJ)</strong> publicou a
                                <strong>Lista Provisória de Classificação Final</strong> do concurso público para ingresso
                                na carreira de funcionário judicial.</p>

                            <p>Este concurso, que atraiu milhares de candidatos em toda Angola, avaliou os conhecimentos dos
                                participantes através de provas escritas realizadas a nível nacional. A lista abrange os
                                cargos de <strong>Escrivão de Direito de 3ª Classe</strong> e <strong>Oficial de Diligências
                                    de 3ª Classe</strong>.</p>
                            ...
                            <div class="alert alert-info border-0 shadow-sm" role="alert">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        Utilize a barra de pesquisa abaixo para procurar pelo seu <strong>nome
                                            completo</strong> ou parte do nome. O sistema mostrará imediatamente o seu
                                        resultado, incluindo a nota obtida e o estado da candidatura.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="csmj-downloads mb-4">
                            <h5 class="fw-bold mb-3"><i class="bi bi-file-earmark-pdf-fill text-danger me-2"></i>Descarregar
                                Listas em PDF</h5>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <a href="https://csmj.ao/storage/Document/FDm6TvE6Nz41Vragg9f90OK1ajOAPHALbwUHPq6G.pdf"
                                        target="_blank" class="csmj-download-card" rel="noopener noreferrer">
                                ...
                                <div class="col-md-6">
                                    <a href="https://csmj.ao/storage/Document/6TlgukHOtUmU1JKlHTlRuA2i74b2RFNvUmG7UTkR.pdf"
                                        target="_blank" class="csmj-download-card" rel="noopener noreferrer">
                                        <div class="csmj-download-icon">
                                            <i class="bi bi-filetype-pdf"></i>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <a href="https://csmj.ao/storage/Document/1C5W82b7oyr4DigqOCmlbLOME2UhCS7MJEYMslQQ.pdf"
                                        target="_blank" class="csmj-download-card" rel="noopener noreferrer">
                                        <div class="csmj-download-icon">
                                            <i class="bi bi-filetype-pdf"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="fw-bold mb-1">Oficial de Diligências — 3ª Classe - Lista 1</h6>
                                            <small class="text-muted">Classificação Final · PDF</small>
                                        </div>
                                        <i class="bi bi-download text-primary fs-5"></i>
                                    </a>
                                ...
                                <div class="col-md-6">
                                    <a href="https://csmj.ao/storage/Document/q7znrUGB1zUbHhgOlWBa9nRl89T7pwJ874qEJzWi.pdf"
                                        target="_blank" class="csmj-download-card" rel="noopener noreferrer">
                                        <div class="csmj-download-icon">
                                            <i class="bi bi-filetype-pdf"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="fw-bold mb-1">Oficial de Diligências — 3ª Classe - Lista 2</h6>
                                            <small class="text-muted">Classificação Final · PDF</small>
                                        </div>
                                        <i class="bi bi-download text-primary fs-5"></i>
                                    </a>
                                ...
                                <div class="col-md-6">
                                    <a href="https://csmj.ao/storage/Document/p65oTPA1law9TTfmd5LoN1iHLNbj1qMjqK2Cgbic.pdf"
                                        target="_blank" class="csmj-download-card" rel="noopener noreferrer">
                                        <div class="csmj-download-icon">
                                            <i class="bi bi-filetype-pdf"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="fw-bold mb-1">Oficial de Diligências — 3ª Classe - Lista 3</h6>
                                            <small class="text-muted">Classificação Final · PDF</small>
                                        </div>
                                        <i class="bi bi-download text-primary fs-5"></i>
                                    </a>
                            ...
                            <div class="csmj-search-box">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" id="searchInput" class="form-control border-start-0 ps-0"
                                        placeholder="Pesquisar pelo seu nome..." autocomplete="off">
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <small class="text-muted"><i class="bi bi-lightbulb me-1"></i> Dica: escreva pelo menos 3
                                    letras do nome</small>
                        ...
                        <div class="mt-5 pt-4 border-top" id="statsSection" style="display:none;">
                            <h4 class="fw-bold mb-3"><i class="bi bi-bar-chart-fill me-2 text-primary"></i>Estatísticas
                                Gerais</h4>
                        ...
                        <div class="mt-5 pt-4 border-top">
                            ...
                            <p class="text-muted">Esta é uma <strong>lista provisória</strong>. Os candidatos poderão
                                apresentar reclamações dentro dos prazos estipulados pelo CSMJ. Recomendamos que todos os
                                candidatos consultem os canais oficiais do Conselho Superior da Magistratura Judicial para
                                informações complementares.</p>
                            <p class="text-muted mb-0"><strong>Fonte:</strong> Conselho Superior da Magistratura Judicial
                                (CSMJ) — Angola</p>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm border-0 mb-4 rounded-3">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="badge bg-warning text-dark rounded-pill px-3 py-2">Admitido não
                                            provido</span>
    ...
    <style>
        ...
        .csmj-nota.nota-media {
            color: #f59e0b;
        }

        .csmj-nota.nota-baixa {
            color: #ef4444;
        }
